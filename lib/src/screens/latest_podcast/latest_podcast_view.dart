...
import 'package:bong/src/screens/latest_podcast/latest_podcast_logic.dart';
...
class LatestPodcastPage extends StatefulWidget {
  const LatestPodcastPage({super.key});

  @override
  State<LatestPodcastPage> createState() => _LatestPodcastPageState();
}

class _LatestPodcastPageState extends State<LatestPodcastPage> {
  final logic = Get.put(LatestPodcastLogic());

  @override
  void dispose() {
    Get.delete<LatestPodcastLogic>();
    super.dispose();
  }
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Obx(
                            () => Text(
                              logic.splashLogic
                                  .currentLanguage['latestPodcasts'],
