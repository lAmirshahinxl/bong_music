...
import 'package:bong/src/screens/viewed_podcast/viewed_podcast_logic.dart';
...
class ViewedPodcastPage extends StatefulWidget {
  const ViewedPodcastPage({super.key});

  @override
  State<ViewedPodcastPage> createState() => _ViewedPodcastPageState();
}

class _ViewedPodcastPageState extends State<ViewedPodcastPage> {
  final logic = Get.put(ViewedPodcastLogic());

  @override
  void dispose() {
    Get.delete<ViewedPodcastLogic>();
    super.dispose();
  }
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Obx(
                              () => Text(
                                logic.splashLogic.currentLanguage['podcast'],
