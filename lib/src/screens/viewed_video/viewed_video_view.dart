...
import 'package:bong/src/screens/viewed_video/viewed_video_logic.dart';
...
class ViewedVideoPage extends StatefulWidget {
  const ViewedVideoPage({super.key});

  @override
  State<ViewedVideoPage> createState() => _ViewedVideoPageState();
}

class _ViewedVideoPageState extends State<ViewedVideoPage> {
  final logic = Get.put(ViewedVideoLogic());

  @override
  void dispose() {
    Get.delete<ViewedVideoLogic>();
    super.dispose();
  }
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Obx(
                              () => Text(
                                logic.splashLogic.currentLanguage['videos'],
  ...
  Widget itemPlaylist(int index) {
    return AnimationConfiguration.staggeredList(
      ...
      child: SlideAnimation(
          ...
          child: Material(
            child: InkWell(
              onTap: () => logic.goToVideoPage(logic.musicList[index]),
              child: Container(
                width: Get.width,
                padding:
